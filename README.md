...
1. How can we extract the first name, last name, and email address of all customers to prepare a comprehensive contact list for the marketing team?
   ...
   [<img src="./IMAGES/email id list.png" alt="email id list.png" width="400"/>](https://www.mysql.com/) &nbsp;


3. What is the total number of movies in the inventory that are available for rent at the lowest rental rate of $0.99?

    [<img src="./IMAGES/CHEAPEST RENTAL.png" alt="CHEAPEST RENTAL.png" width="400"/>](https://www.mysql.com/) &nbsp;


5. How can we categorize all movies based on their rental rates and determine the count of movies in each category?

    [<img src="./IMAGES/TOTAL_NUMBER_OF_MOVES.png" alt="TOTAL_NUMBER_OF_MOVES.png" width="400"/>](https://www.mysql.com/) &nbsp;
...
11. -- How Many Rental We Have For Each Month
    ...
    [<img src="./IMAGES/RENTAL_PER_MONTH.png" alt="RENTAL_PER_MONTH.png" width="400"/>](https://www.mysql.com/) &nbsp;
...
12. -- Could you pull all payment from our first 100 customer (Based on customer_id)
       ...
       [<img src="./IMAGES/first 100 customer.png" alt="first 100 customer.png" width="400"/>](https://www.mysql.com/) &nbsp;
...
14. -- Now, could you please write a query to pull all payments from those specific customers, along with payments over $5, from any customer?
      ...
      [<img src="./IMAGES/payment_from_specificcustomer.png" alt="payment_from_specificcustomer.png" width="400"/>](https://www.mysql.com/) &nbsp;
